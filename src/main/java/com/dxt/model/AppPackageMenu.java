...
public class AppPackageMenu {
    ...
    public void createAppPackageMenuByAppMenuBeanList(List<AppMenuBean> list) {
    ...
    static class SecondLevelMenu {
        ...
        public SecondLevelMenu(AppMenuBean appMenuBean) {
            ...
            this.network = appMenuBean.getNetwork();
            this.offerId = appMenuBean.getExt1();
        }
